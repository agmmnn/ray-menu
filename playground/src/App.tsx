...
import { TheHelm, useRadialMenu, type MenuItem, type EdgeBehavior } from 'radial-menu'
...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    label: 'Share',
    children: [
      { id: 'share-email', label: 'Email', onSelect: () => console.log('Share via Email') },
      { id: 'share-link', label: 'Copy Link', onSelect: () => console.log('Copy Link') },
      { id: 'share-social', label: 'Social', onSelect: () => console.log('Share Social') },
    ],
  },
  {
    id: 'settings',
    ...
    <div className="min-h-screen p-8">
      ...
      <header className="max-w-4xl mx-auto mb-12">
        ...
        <p className="text-zinc-400">
          Right-click anywhere to open the menu. With infinite selection enabled,
          the slice stays selected even when your cursor moves far beyond the menu.
        </p>
      </header>
        ...
        <div className="relative">
          ...
          >
            <p className="text-zinc-400 text-center px-4">
              Right-click here<br/>
              <span className="text-xs text-zinc-500">Move cursor far away to test infinite selection</span>
            </p>
          </div>
          <p className="mt-2 text-sm text-zinc-500">Context menu trigger area</p>
        </div>
        ...
        <div className="relative md:col-span-2">
          ...
          >
            <p className="text-zinc-400 text-center">
              Right-click near edges to test edge behavior<br/>
              <span className="text-xs text-zinc-500">Try flip vs shift vs none modes</span>
            </p>
          </div>
          <p className="mt-2 text-sm text-zinc-500">
            Edge detection demo area
          </p>
        </div>
      </div>

      {/* Render the menu */}
      <TheHelm menu={menu} showDriftTrace={showTrace} />
